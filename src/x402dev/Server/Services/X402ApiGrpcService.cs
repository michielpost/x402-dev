        ...
        IHttpContextAccessor httpContextAccessor) : IX402ApiGrpcService
    {
        ...
        private static X402ApiModel Map(Database.Models.X402Api api)
        {
            ...
            return new X402ApiModel
            {
                ...
                Added = DateTime.SpecifyKind(api.AddedDateTime.DateTime, DateTimeKind.Utc),
                LastCheck = api.LastCheckDateTime.HasValue ? DateTime.SpecifyKind(api.LastCheckDateTime.Value.DateTime, DateTimeKind.Utc) : null,
                NextCheck = api.NextCheckDateTime.HasValue ? DateTime.SpecifyKind(api.NextCheckDateTime.Value.DateTime, DateTimeKind.Utc) : null,
                LastSuccess = api.LastSuccessDateTime.HasValue ? DateTime.SpecifyKind(api.LastSuccessDateTime.Value.DateTime, DateTimeKind.Utc) : null,
                LastError = api.LastErrorDateTime.HasValue ? DateTime.SpecifyKind(api.LastErrorDateTime.Value.DateTime, DateTimeKind.Utc) : null,
